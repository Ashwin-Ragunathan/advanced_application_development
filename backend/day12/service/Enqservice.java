...
public class Enqservice {
    ...
    public Enqdto updateServiceByName(String name, Enqdto updatedServicedto) {
        ...
        if (existingService != null) {
            ...
            existingService.setNumberofdays(updatedServicedto.getNumberofdays());
            existingService.setNumberofpersons(updatedServicedto.getNumberofpersons());
...
//         enqrepo.deleteByFirstname(name);
//     }
// }
