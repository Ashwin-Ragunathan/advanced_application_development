...
function Services() {
  return (
    ...
    <div className="about-me">
      ...
      <p className='para'>This is the best option for cruising through the heavenly backwaters of Maharastra<br></br><br></br>Location:Tarkali<br></br>Plan:2 NIGHTS / 3 DAYS<br></br>Cost:10,000/-</p>
     <Link to='/bookings'> <button className='button-33'>BOOK NOW</button></Link></div>
      ...
      <p className='para'>Offering river views, Alif Laila Group of Houseboats, Udupi is an accommodation.<br></br><br></br>Location:Udupi<br></br>Plan:3 NIGHTS / 4 DAYS<br></br>Cost:17,000/-</p><br></br>
      ...
      <p className='para'>Houseboat package in Sarban is better for Failies, You can bathe in the breathtaking beauty of Maharastra<br></br> <br></br>Location:SundarBan<br></br>Plan:4 NIGHTS / 5 DAYS<br></br>Cost:26,500/- </p>
      <Link to='/bookings'> <button className='button-33'>BOOK NOW</button></Link></div>
    </div>
