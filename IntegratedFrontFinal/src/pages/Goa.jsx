...
function Services() {
  return (
    ...
    <div className="about-me">
      ...
      <p className='para'>Set on the beachfront, this property features a private beach area, a terrace and a bar with Desirable foods.<br></br><br></br>Location:Chopdem<br></br>Plan:2 NIGHTS / 3 DAYS<br></br>Cost:9,000/-</p>
     <Link to='/bookings'> <button className='button-33'>BOOK NOW</button></Link></div>
      ...
      <p className='para'>Anjuna beach provides accommodation with a fitness centre, free private parking <br></br><br></br>Location:Candolim<br></br>Plan:3 NIGHTS / 4 DAYS<br></br>Cost:13,000/-</p><br></br>
      ...
      <p className='para'> Four Season - Close to Candolim Beach offers accommodation with a garden, free private parking, a terrace and a restaurant.<br></br><br></br>Location:Panaji<br></br>Plan:4 NIGHTS / 5 DAYS<br></br>Cost:20,000/- </p>
      <Link to='/bookings'> <button className='button-33'>BOOK NOW</button></Link></div>
    </div>
